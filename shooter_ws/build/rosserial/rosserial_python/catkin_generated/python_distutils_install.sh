...
echo_and_run cd "/home/ubuntu/NVIDIAShooter/shooter_ws/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ubuntu/NVIDIAShooter/shooter_ws/src/rosserial/rosserial_python/setup.py" \
    build --build-base "/home/ubuntu/NVIDIAShooter/shooter_ws/build/rosserial/rosserial_python" \
    install \
    $DESTDIR_ARG \
