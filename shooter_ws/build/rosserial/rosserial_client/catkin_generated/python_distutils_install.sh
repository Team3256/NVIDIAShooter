...
echo_and_run cd "/home/ubuntu/shooter_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ubuntu/shooter_ws/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/ubuntu/shooter_ws/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
