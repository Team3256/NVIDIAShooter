...
(cl:defmethod cl:initialize-instance :after ((m <JoyValues>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JoyValues)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name shooter-msg:<JoyValues> is deprecated: use shooter-msg:JoyValues instead.")))

(cl:ensure-generic-function 'axis_vals-val :lambda-list '(m))
(cl:defmethod axis_vals-val ((m <JoyValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shooter-msg:axis_vals-val is deprecated.  Use shooter-msg:axis_vals instead.")
  (axis_vals m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <JoyValues>) ostream)
  ...
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let ((bits (roslisp-utils:encode-single-float-bits ele)))
   ...
   (cl:slot-value msg 'axis_vals))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <JoyValues>) istream)
  "Deserializes a message object of type '<JoyValues>"
  (cl:setf (cl:slot-value msg 'axis_vals) (cl:make-array 2))
  (cl:let ((vals (cl:slot-value msg 'axis_vals)))
    (cl:dotimes (i 2)
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<JoyValues>)))
  ...
  "0e690cc92bcfca43c513ed996fe91f2c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'JoyValues)))
  "Returns md5sum for a message object of type 'JoyValues"
  "0e690cc92bcfca43c513ed996fe91f2c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JoyValues>)))
  ...
  (cl:format cl:nil "float32[2] axis_vals~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JoyValues)))
  "Returns full string definition for message of type 'JoyValues"
  (cl:format cl:nil "float32[2] axis_vals~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <JoyValues>))
  (cl:+ 0
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'axis_vals) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <JoyValues>))
  "Converts a ROS message object to a list"
  (cl:list 'JoyValues
    (cl:cons ':axis_vals (axis_vals msg))
))
