...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_windows_SOURCE_PREFIX /home/ubuntu/NVIDIAShooter/shooter_ws/src/rosserial/rosserial_windows)
  set(rosserial_windows_DEVEL_PREFIX /home/ubuntu/NVIDIAShooter/shooter_ws/devel)
  ...
  set(rosserial_windows_INSTALL_PREFIX /home/ubuntu/NVIDIAShooter/shooter_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_windows' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/NVIDIAShooter/shooter_ws/src/rosserial/rosserial_windows/${idir}'.  Ask the maintainer 'Kareem Shehata <kshehata@clearpathrobotics.com>' to fix it.")
    endif()
