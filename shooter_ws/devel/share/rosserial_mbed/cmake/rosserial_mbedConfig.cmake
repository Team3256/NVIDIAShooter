...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_mbed_SOURCE_PREFIX /home/ubuntu/shooter_ws/src/rosserial/rosserial_mbed)
  set(rosserial_mbed_DEVEL_PREFIX /home/ubuntu/shooter_ws/devel)
  ...
  set(rosserial_mbed_INSTALL_PREFIX /home/ubuntu/shooter_ws/install)
...
if(NOT "/home/ubuntu/shooter_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_mbed' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/shooter_ws/src/rosserial/rosserial_mbed/${idir}'.  Ask the maintainer 'Gary Servin <garyservin@gmail.com>' to fix it.")
    endif()
