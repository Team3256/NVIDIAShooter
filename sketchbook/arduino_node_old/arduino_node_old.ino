...
Subscriber<std_msgs::Float32> lmotor_sub("left_drive", &lmcallback);
Subscriber<std_msgs::Float32> rmotor_sub("right_drive", &rmcallback);
Subscriber<std_msgs::Bool> lbarrel_sub("left_barrel", &lbcallback);
Subscriber<std_msgs::Bool> rbarrel_sub("right_barrel", &rbcallback);
